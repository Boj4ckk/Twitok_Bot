...
from edit import Clip  # Import the Clip class to create video clip instances
...
import tiktok_api  # Import logging to capture processing information
...
if choice == 1:
    ...
    clipInstance = Clip(
        ...
        url=r"C:\\Users\\user\\Desktop\\Twitok_Bot\\TwiTok_bot\\edit\\clip_twitch\\ClearGiantMinkTheTarFu-9yfSs-DcvGj8Q7tX.mp4",  # Path to the video file (to be updated)
        views=1  # Number of views (initially set to 1)
    )

    # Output path for the processed clip with blur effect
    outputPath = r"C:\\Users\\user\\Desktop\\Twitok_Bot\\TwiTok_bot\\edit\\clip_processed\\clip p_ClearGiantMinkTheTarFu-9yfSs-DcvGj8Q7tX.mp4.mp4"  # Path where the processed clip will be saved (to be updated)
